...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d6 = new Department(6, "Movies");

            Seller s1 = new Seller(1, "Alexis Perea", "aperea@sales.com", new DateTime(1999, 7, 9), 5000, d1);
            Seller s2 = new Seller(2, "Bruna Cardoso", "bcardoso@sales.com", new DateTime(1986, 12, 9), 8000, d2);
            Seller s3 = new Seller(3, "Leo Pereira", "lpereira@sales.com", new DateTime(1992, 08, 20), 7000, d3);
            Seller s4 = new Seller(4, "Esteban Mondragon", "emondragon@sales.com", new DateTime(1991, 1, 16), 10000, d4);
            Seller s5 = new Seller(5, "Adao Perea", "aperea@sales.com", new DateTime(1983, 2, 17), 9000, d5);
            Seller s6 = new Seller(6, "Ysabel Perea", "yperea@sales.com", new DateTime(1993, 2, 6), 9500, d3);
            Seller s7 = new Seller(7, "Juliana Silva", "jbrito@sales.com", new DateTime(1995, 7, 13), 4500, d6);
